        ...
        <div className="container">
          <section className="newsDetailLayout">
            <div className="newsDetailMain">
              ...
              {bottomPosts.length > 0 ? (
                <section className="newsDetailMoreSection">
                  <div className="newsDetailMoreHeader">
                    <div>
                      <span className="newsDetailMiniBadge">
                        Related Coverage
                      </span>

                      <h2 className="newsDetailMoreTitle">
                        More stories from ETN
                      </h2>
                    </div>

                    <span className="newsDetailMoreSubtext">
            ...
            <aside className="newsDetailSidebar sidebarBlock">
              <div className="newsDetailSidebarCard">
                <div className="newsDetailSidebarHeader">
                  <span className="newsDetailMiniBadge">ETN Sidebar</span>
                ...
                {sidebarPosts.length > 0 ? (
                  ...
                  <div className="newsDetailSidebarEmpty">
